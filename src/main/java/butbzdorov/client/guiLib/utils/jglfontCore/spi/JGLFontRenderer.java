package butbzdorov.client.guiLib.utils.jglfontCore.spi;
...
/**
 * The interface necessary to let jglfontCore render a Bitmap. The actual resource loading of bitmap files needs to be done
 * in here. jglfontCore acts as a provider of the glyph data and JGLFontRenderer implementations can use whatever way
